...
public class EncryptionUtil {
	...
	public static final String ENCRYPT_KEY = "GOLDSIGN"; // 加密解密Key
	...
	public static String biEncrypt(String value) {
		return biEncrypt(ENCRYPT_KEY, value);
	}


	//解密  只能英文、数字加密
	public static String biDecrypt(String value) {
		return biDecrypt(ENCRYPT_KEY, value);
	}
	 ...
	 */
	public static String replaceEncryptKey(String encryptKey, String replacements, String
			splitRegex) {
		if (StringUtils.isNotEmpty(encryptKey) && StringUtils.isNotEmpty(replacements)) {
...
//	}
	...
	public static void main(String[] args) {
		...
		String strEnc = getEncString(str);// 加密字符串,返回String的密文
