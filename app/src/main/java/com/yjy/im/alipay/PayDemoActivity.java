...
public class PayDemoActivity extends FragmentActivity {
	...
	// 商户PID,商户收款账号
	public String PARTNER, SELLER, sign, notify_url, app_id, appenv,
			out_trade_no, return_url, from = null;
	...
	private TextView product_subject, product_body, product_total;
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SDK_PAY_FLAG: {
				...
				VolleyRequest vr=new VolleyRequest(Request.Method.POST, WebLinksUtil.alipay, params, new Response.Listener() {
					@Override
					public void onResponse(Object o) {

						if(o!=null){
							Log.v("PayDemoActivity",o.toString());
						}
				...
				VolleyUtil.getVolleyUtil(PayDemoActivity.this).addToRequestQueue(vr, "PayDemoActivity");
				...
				if (TextUtils.equals(resultStatus, "9000")) {
					...
					if (TextUtils.equals(resultStatus, "8000")) {
						...
						if (from != null
								&& from.equals("ServiceSettleActivity")) {
							Toast.makeText(PayDemoActivity.this, "订单提交成功，未支付！",
									Toast.LENGTH_SHORT).show();
						} else {

							Toast.makeText(PayDemoActivity.this, "未支付",
									Toast.LENGTH_SHORT).show();
						}
				...
				bundle.putString("flag", "55");
				Intent intent;
				if (from != null && from.equals("ServerOrderActivity")) {
					intent = new Intent(PayDemoActivity.this,
							MyServiceOrderActivity.class);
				} else if (from != null && from.equals("ServiceSettleActivity")) {
					intent = new Intent(PayDemoActivity.this,
							ApplySuccessActivity.class);
				}  else if (from != null && from.equals("ServiceOrderDetailActivity")) {
					intent = new Intent(PayDemoActivity.this,
							ServiceOrderDetailActivity.class);
				}else if(from != null && from.equals("OrderActivity")){
					intent = new Intent(PayDemoActivity.this,
							OrderActivity.class);
				}else {
					intent = new Intent(PayDemoActivity.this,
...
//		init();
	...
	private void init() {
		...
		product_body = (TextView) findViewById(R.id.product_body);
		product_total = (TextView) findViewById(R.id.product_price);
		product_subject.setText(subject);
		product_body.setText(body);
		product_total.setText(total_fee);
	}
